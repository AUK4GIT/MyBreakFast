...
#define VanityUrl @"nativeSDK"
 //Uninor
//#define VanityUrl @"8h2g2ic95k"

//#define ReturnUrl @"http://192.168.1.48:8888/return.php"
//#define ReturnUrl @"http://localhost:8888/return.php"
#define ReturnUrl @"https:\/\/salty-plateau-1529.herokuapp.com\/redirectURL.sandbox.php"


//#define BillUrl @"http://192.168.1.48:8888/billgenerator.php"
