...
struct Constants {
 /*
    ...
    struct API {
        ...
        static let UserLogin: String = "http://www.firsteat.in/andro/index.php/ws/verify/mobile/user"
        ...
        static let PlaceOrder: String = "http://www.firsteat.in/andro/index.php/ws/orders/add/new/alpha/"
