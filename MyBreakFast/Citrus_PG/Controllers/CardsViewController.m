...
//    UIPickerView *pickerView = [[UIPickerView alloc] init];
    ...
    accessoryToolbar.barTintColor = [UIColor colorWithRed:200.0/255.0 green:5.0/255.0 blue:15.0/255.0 alpha:1.0];
    // Configure toolbar .....
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (tableView == self.saveCardsTableView) {
        ...
        CTSPaymentOption *paymentOption = [saveCardsArray objectAtIndex:0];
