...
#define CACHE_KEY_ONE_TAP_PAYMENT @"OneTapPayment"
#define CACHE_KEY_PUSH_VIEW_CONTROLLER @"PushViewController"

#define BASE_URL @"BASE_URL"
#define DP_BASE_URL @"DP_BASE_URL"
#define NEW_PAYMENT_BASE_URL @"NEW_PAYMENT_BASE_URL"
#define BANK_LOGO_KEY @"BANK_LOGO_KEY"
#define BANK_LOGO_WITH_BANK_NAME_KEY @"BANK_LOGO_WITH_BANK_NAME_KEY"
...
#define CACHE_KEY_LOADER_OVERLAY @"LoaderOverlay"
#define CACHE_KEY_LOADER_COLOR @"LoaderOverlayColor"
