...
- (void)viewDidLoad
{
    ...
    self.webview.backgroundColor = [UIColor colorWithRed:200.0/255.0 green:5.0/255.0 blue:15.0/255.0 alpha:1.0];
...
//         [self.webview loadHTMLString:redirectURL baseURL:[NSURL URLWithString:[CTSUtility fetchFromEnvironment:NEW_PAYMENT_BASE_URL]]];
            ...
            //For all bank its working fine even for those 6 banks.
            [self.webview loadHTMLString:redirectURL baseURL:nil];
        }
    }else{
