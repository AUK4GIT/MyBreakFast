...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-MyBreakFast/Bolts.framework"
  install_framework "Pods-MyBreakFast/FBSDKCoreKit.framework"
  install_framework "Pods-MyBreakFast/FBSDKLoginKit.framework"
